...
func (c *NotificationClient) Create(ctx context.Context, userID int, notificationType string, title string, message string) {
	c.CreateAction(ctx, userID, notificationType, title, message, "", "", "")
}

func (c *NotificationClient) CreateAction(ctx context.Context, userID int, notificationType string, title string, message string, actionType string, actionRef string, actionLabel string) {
